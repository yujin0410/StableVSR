...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        help=(
            ...
            " or to a folder containing files that ?쨽 Datasets can understand."
        ),
    )
    parser.add_argument(
        "--dataset_config_path",
...
def main(args):
    ...
    dtcwt_model = DTCWTForward(J=3, biort='near_sym_a', qshift='qshift_a') # 파라미터는 예시
    dtcwt_model = dtcwt_model.to(accelerator.device, dtype=weight_dtype)
    dtcwt_model.requires_grad_(False) # 특징 추출용은 Frozen
